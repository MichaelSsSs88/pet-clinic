...
public class DataLoader  implements CommandLineRunner {
    ...
    private void loadData() {
        ...
        owner1.setCity("London1");
        owner1.setTelephone("0393029903409");
        owner1.getPets().add(pet);
        System.out.println(owner1.getCity());
        ...
        Vet vet5= new Vet();
        //vet3.setId(3L);
        vet5.setFirstName("George");
        vet5.setLastName("Mackington");
        ...
        Vet vet6= new Vet();
        //vet3.setId(3L);
        vet6.setFirstName("Karol");
        vet6.setLastName("Ramirez");
